...
//	example link 		http://ww1.microchip.com/downloads/en/devicedoc/doc0787.pdf
//	example site page	https://phoenixnap.com/kb/wget-command-with-examples
//	example site		https://www.lookout.net/
...
func main()  {
	...
	if cmd.Site {
		...
		filepathToDownload := "/home/ruslan/0_wb/l2/develop/dev09/files/" + folderName
		...
		err = downloadFile("/home/ruslan/0_wb/l2/develop/dev09/files" + u.Path, downloadURL)
		if err != nil {
			log.Println(err)
		}
	}
...
//func findLinksInFile(host, filePath string)  {
//	dataFromFile, err := os.ReadFile()
//}
...
func RecursiveDownload(pathMap map[string]struct{}, folderPath, URL string) {
	...
	fmt.Println(sliceOfLinksFromCurrentFile)
